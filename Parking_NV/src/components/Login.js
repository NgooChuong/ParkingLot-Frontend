...
import APIs, { authAPIs, endpoints, identityApi } from "../configs/APIs";
...
const LoginNV = () => {
    ...
    const handleFaceAuthentication = async (e) =>{
      e.preventDefault();
      try{
          let res = await identityApi().post(endpoints['face']);
          cookie.save("token", res.data.result.token);
      ...
      <div className="card p-4 shadow" style={{ maxWidth: '400px', width: '100%' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {loading &&
            ...
            <button type="button" className="btn btn-primary d-block mx-auto" style={{margin:"20px"}}
                onClick={(e) => handleFaceAuthentication(e)}
              >
                Face Login
